...
public class DialogExitBindingImpl extends DialogExitBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btnExit, 5);
        sViewsWithIds.put(R.id.btnConfirm, 6);
    }
    // views
    @NonNull
    ...
    private DialogExitBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (vn.xdeuhug.luckyMoney.widget.AppButtonBold) bindings[6]
            , (vn.xdeuhug.luckyMoney.widget.AppButtonBold) bindings[5]
            , (android.widget.LinearLayout) bindings[2]
            , (vn.xdeuhug.luckyMoney.widget.AppTextView) bindings[3]
